...
class LogReconstructionCallback(Callback):
    ...
    def on_validation_batch_end(
        ...
        fig.suptitle(
            f"epoch {trainer.current_epoch}: Loss={out_criterion['loss']:.4f}, MSE={out_criterion['mse']:.4f}, SSIM={out_criterion['ssim']}, MS-SSIM={out_criterion['ms_ssim']} , BPP={out_criterion['bpp_loss']:.4f}"
        )
        plt.tight_layout()
